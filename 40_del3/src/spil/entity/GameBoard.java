...
public class GameBoard {
	...
	private final spil.entity.field.Field[][] fields = { { new Territory(FieldBoundary.territoryPrices[0], FieldBoundary.territoryRents[0]),
			...
			new LaborCamp(FieldBoundary.laborCampPrices[0]),
			new LaborCamp(FieldBoundary.laborCampPrices[1]), 
			new Tax(FieldBoundary.taxRents[0]), 
			new Tax(FieldBoundary.taxRents[1]),
			new Fleet(FieldBoundary.fleetPrices[0]),
			new Fleet(FieldBoundary.fleetPrices[1]), 
			new Fleet(FieldBoundary.fleetPrices[2]),
